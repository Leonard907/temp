...
def test_l4lb1():
    ...
    n1n2 = genpktin(cmac, macs[0], cip, vip, ports[0], dport, dp, 1,
            bits=TCP_SYN)
    n2n1 = genpktin(macs[0], cmac, ips[1], cip, dport, ports[0], dp, 2,
...
def test_l4lb2():
    ...
    n1n2_3 = genpktin(cmac, macs[0], cip, vip, ports[2], dport, dp, 1,
            bits=TCP_SYN)
    n2n1_3 = genpktin(macs[0], cmac, ips[1], cip, dport, ports[2], dp, 2,
            bits=TCP_SYN | TCP_ACK)
...
def test_l4lb3():
    ...
    ap = arp.arp.parser(dp.out.to_jsondict()['OFPPacketOut']['data'][14:])[0]
    print('target', ap.dst_ip, ap.dst_mac, ap.src_ip, ap.src_mac)
    print('arp', ips[0], macs[0], cip, cmac)
